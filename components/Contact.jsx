  ...
  return (
    <div className="relative bg-gray-50 py-12">
      ...
      <div className="relative z-20 grid grid-cols-1 md:grid-cols-2 gap-8 px-6 md:px-12">
        {/* Map Section */}
        <div className="w-full h-full bg-gray-200 rounded-md shadow-md overflow-hidden z-30">
          <iframe
        ...
        <div className="bg-white rounded-md shadow-md p-6 md:p-8">
          <h3 className="text-xl font-semibold text-customBlue text-customTeal mb-4">
            Submit a Query
          </h3>
