  ...
  return (
    ...
    <div className="container relative z-10 px-5 py-24 mx-auto lg:px-24">
      ...
      <div className="text-center mt-10">
        <a
          href="https://g.page/r/CXJSyTE1qU4AEAE/review"
          target="_self"
          className="inline-block text-customOrange font-semibold py-3 px-8 rounded-md text-lg shadow-md transition-all duration-300 cursor-pointer hover:bg-opacity-90"
        >
          Add Review
        </a>
      </div>
